...
gpu.module @test_distribution {
  ...
  gpu.func @vector_reduce_cross_sg_dim_0(%src: memref<256x128xf32>) {
    ...
    // CHECK-DAG: %[[AFFINE1:.*]] = affine.apply #map()[%[[SGID2]]]
    // CHECK-DAG: %[[AFFINE2:.*]] = affine.apply #map1()[%[[SGID2]]]
  ...
  gpu.func @vector_reduce_multi_dim(%src: memref<?xf32>) {
    ...
    // CHECK-DAG: %[[SGID:.*]] = gpu.subgroup_id : index
    // CHECK-DAG: %[[AFFINE0:.*]] = affine.apply #map()[%[[SGID]]]
    // CHECK-DAG: %[[AFFINE1:.*]] = affine.apply #map1()[%[[SGID]]]
    // CHECK-DAG: %[[AFFINE2:.*]] = affine.apply #map2()[%[[SGID]]]
    // CHECK-DAG: %[[AFFINE3:.*]] = affine.apply #map3()[%[[SGID]]]
    // CHECK-DAG: %[[AFFINE4:.*]] = affine.apply #map4()[%[[SGID]]]
    // CHECK-DAG: %[[AFFINE5:.*]] = affine.apply #map5()[%[[SGID]]]
